...
import css.properties.FontWeightValue.`500`
import css.properties.FontWeightValue.`400`
import css.properties.FontWeightValue.`300`
import css.properties.FontWeightValue.`200`
...
public fun Rule._typography(typography: TYPOGRAPHY) {
    when(typography){
        TYPOGRAPHY.H1 -> {
